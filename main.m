...
while ~isDone(obj.reader)
    ...
    function displayTrackingResults()
        ...
        if ~isempty(tracks)
            ...
            if ~isempty(reliableTracks)
                ...
                % save candidates
                if isempty(find(predictedTrackInds > 0, 1)) == 0
                    saveCandidatesToLocal(frame, bboxes(predictedTrackInds, :), ids(predictedTrackInds));
                end
    ...
    function saveCandidatesToLocal(frame, bboxes, ids)
        rows = size(bboxes, 1);
